...
kc_add_map(
    array(
        'jalil_posts' => array(
            'name' => esc_html__('Post', 'jalil-toolkit'),
            'description' => esc_html__( 'Use this addon for displaing post', 'jalil-toolkit' ),
            'icon' => 'sl-picture',
            ...
            'params' => array(
            	'General' => array(
                    ...
                    array(
                        'name' => 'num_words',
                        'label' => esc_html__('Show Words', 'jalil-toolkit'),
                        'type' => 'text',
                        'description' => esc_html__('How many words are you want to show.', 'jalil-toolkit'),
                        'value' => '21',
                    ),
            	),
            ),
