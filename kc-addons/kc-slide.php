...
kc_add_map(
    array(
        'jalil_slides' => array(
            'name' => esc_html__('Slider', 'jalil-toolkit'),
            'description' => esc_html__( 'Use this addon for displaing slider', 'jalil-toolkit' ),
            'icon' => 'sl-picture',
            ...
            'params' => array(
            	'General' => array(
                    array(
                        ...
                        'type'  => 'text',
                        'description' => esc_html__('If you want to show unlimited project post, Please type -1 from here.', 'jalil-toolkit'),
                        'value' => '-1',
                    ),
                    array(
                        'name' => 'order',
                        'label' => esc_html__('Slide Order', 'jalil-toolkit'),
                        'type'  => 'select',
                        'description' => esc_html__('Select slide order from here.', 'jalil-toolkit'),
                        'options' => array( 
                            'ASC'     =>  esc_html__('Ascending Slide', 'jalil-toolkit'),
                            'DESC'    =>  esc_html__('Descending Slide', 'jalil-toolkit'),
                        ),
                        'value' => 'ASC',
                    ),
                    array(
                    ...
                    array(
                        'name' => 'nav',
                        'label' => esc_html__('Enable Nav?', 'jalil-toolkit'),
                        'type' => 'select',
                        'description' => esc_html__('If you want to show nav, Please select yes.', 'jalil-toolkit'),
                        'options' => array( 
                            'true'    =>  esc_html__('Yes', 'jalil-toolkit'),
                            'false'    =>  esc_html__('False', 'jalil-toolkit'),
                        ),
